...
export default async function LeadershipPage() {
  ...
  return (
    <div className="space-y-6 animate-slide-up">
      <div>
        <h1 className="text-3xl font-black text-white">Leadership Panel</h1>
      ...
      <div className="grove-card border-grove-border">
        <h2 className="text-sm font-semibold text-grove-green uppercase tracking-widest mb-3">⭐ Panou Leadership</h2>
        <p className="text-zinc-500 text-sm">Folosește meniul din stânga pentru a gestiona invoiri, demisii și puncte.</p>
      </div>
    </div>
  )
}
