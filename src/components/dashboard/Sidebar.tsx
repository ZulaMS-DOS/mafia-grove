...
import { LayoutDashboard, Clock, FileText, LogOut, Star, Users, Trophy, Coins } from 'lucide-react'
    ...
    <aside className="w-60 bg-dark-card border-r border-dark-border flex flex-col shrink-0">
      ...
      <div className="p-5 border-b border-dark-border">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-grove-dim border border-grove-border flex items-center justify-center text-lg">
            🏚️
          </div>
          <div>
      ...
      <div className="p-3 border-t border-dark-border">
        <button onClick={() => signOut({ callbackUrl: '/auth/login' })}
          className="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm text-zinc-600
